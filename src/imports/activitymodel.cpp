    ...
    : QAbstractListModel(parent)
{
    ...
    connect(&m_service, &Consumer::activityRemoved, this, &ActivityModel::onActivityRemoved);
    connect(&m_service, &Consumer::currentActivityChanged, this, &ActivityModel::onCurrentActivityChanged);
