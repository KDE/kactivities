...
#ifndef JOBS_SCHEDULER_RETRY_H_
#define JOBS_SCHEDULER_RETRY_H_
...
public:
    Retry(JobFactory * _input, JobFactory * _test, JobFactory * _error, QObject * parent = 0);
    virtual ~Retry();
